...
BOARD_KERNEL_CMDLINE += vga=current i915.modeset=1 drm.atomic=1 i915.nuclear_pageflip=1 drm.vblankoffdelay=1 i915.fastboot=1 video=eDP-1:d video=SVIDEO-1:d
{{^acrn-guest}}
{{#enable_guc}}
